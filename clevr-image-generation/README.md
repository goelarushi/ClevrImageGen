...
render_images.py includes 2D bounding box generation.
Images are generated with size 64x64, with 4 max objects per image. Test set- 10000 images and training set - 25000 images. 

Install blender 2.78c (https://download.blender.org/release/Blender2.78/) and run from the blender folder to generate clevr images. 
